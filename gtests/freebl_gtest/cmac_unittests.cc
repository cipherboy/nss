...
static const size_t kNistPlaintextLengthsCount = PR_ARRAY_SIZE(kNistPlaintextLengths);
...
static const uint8_t kNistKnown[][AES_BLOCK_SIZE] = {
    ...
    {0xE1, 0x99, 0x21, 0x90, 0x54, 0x9F, 0x6E, 0xD5, 0x69, 0x6A, 0x2C, 0x05,
     0x6C, 0x31, 0x54, 0x10}};
PR_STATIC_ASSERT(PR_ARRAY_SIZE(kNistKnown) == kNistKeyLengthsCount * kNistPlaintextLengthsCount);
