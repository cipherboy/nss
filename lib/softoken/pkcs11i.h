...
CK_RV sftk_MAC_Update(sftk_MACCtx *ctx, CK_BYTE_PTR data, CK_ULONG data_len);
CK_RV sftk_MAC_Finish(sftk_MACCtx *ctx, CK_BYTE_PTR result, CK_ULONG_PTR result_len, CK_ULONG max_result_len);
