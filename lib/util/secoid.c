...
CONST_OID aes128_KEY_WRAP_PAD[] = { AES, 8 };
...
CONST_OID aes192_KEY_WRAP_PAD[] = { AES, 28 };
...
CONST_OID aes256_KEY_WRAP_PAD[] = { AES, 48 };
...
const static SECOidData oids[SEC_OID_TOTAL] = {
    ...
    OD(pkixExtendedKeyUsageIPsecUser,
       ...
       "IPsec User",
       CKM_INVALID_MECHANISM, INVALID_CERT_EXTENSION),
    OD(aes128_KEY_WRAP_PAD, SEC_OID_AES_128_KEY_WRAP_PAD,
       "AES-128 Key Wrap Pad", CKM_AES_KEY_WRAP_PAD, INVALID_CERT_EXTENSION),
    OD(aes192_KEY_WRAP_PAD, SEC_OID_AES_192_KEY_WRAP_PAD,
       "AES-192 Key Wrap Pad", CKM_AES_KEY_WRAP_PAD, INVALID_CERT_EXTENSION),
    OD(aes256_KEY_WRAP_PAD, SEC_OID_AES_256_KEY_WRAP_PAD,
       "AES-256 Key Wrap Pad", CKM_AES_KEY_WRAP_PAD, INVALID_CERT_EXTENSION),
};
